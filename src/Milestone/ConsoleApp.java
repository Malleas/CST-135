...
public class ConsoleApp {
    ...
    public static int contactTypeMenu() {
        int contactType;
        Scanner input = new Scanner(System.in);
    ...
    public static void createPersonContact() {
        ...
        String contactPhotoFileName = input.next();
        System.out.println("Enter date of photo");
        String contactPhotoDate = input.next();
        System.out.println("Enter photo description");
        String contactPhotoDescription = input.next();
        System.out.println("Enter street address");
        String contactStreetAddress = input.next();
        System.out.println("Enter city");
        String contactCity = input.next();
        System.out.println("Enter State");
        String contactState = input.next();
        System.out.println("Enter zip code");
        int contactZipCode = input.nextInt();
        System.out.println("Enter date of birth");
        String contactDOB = input.next();
        System.out.println("Enter contact description");
        String contactDescription = input.next();
    ...
    public static void updatePhoto(AddressBook book, int contactId) {
        ...
        switch (selection) {
            ...
            case 2:
                ...
                String updatedFileName = fileNameInput.next();
            ...
            case 3:
                ...
                String updatedDate = photoDateInput.next();
            ...
            case 4:
                ...
                String updatedDesc = photoDescInput.next();
    ...
    public static void updateLocation(AddressBook book, int contactId) {
        ...
        switch (selection) {
            case 1:
                ...
                String updatedStreetAddress = streetInput.next();
            ...
            case 2:
                ...
                String updatedCity = cityInput.next();
            ...
            case 3:
                ...
                String updatedState = stateInput.next();
    ...
    public static void updateContact(AddressBook book, int contactId) {
        ...
        switch (selection) {
            case 1:
                ...
                String upadteName = nameInput.next();
            ...
            case 2:
                ...
                String updatedPhone = phoneInput.next();
            ...
            case 5:
                ...
                String updatedDoB = dobInput.next();
            ...
            case 6:
                ...
                String updatedDesc = contactDescInput.next();
            ...
            case 9:
                ...
                System.out.println("Please provide updated opening time:");
                String updatedUrl = urlInput.next();
    ...
    public static void main(String[] args) {
        ...
        switch (userInput) {
            ...
            case 1:
                int contactType = contactTypeMenu();
                switch (contactType) {
                    case 1:
                        createPersonContact();
                        break;
            ...
            case 5:
              ...
              String searchName = searchNameInput.next();
          ...
          case 6:
            ...
            String searchCity = searchCityInput.next();
          ...
          case 7:
            ...
            String searchDescription = searchDescriptionInput.next();
